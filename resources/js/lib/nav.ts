...
export function getNavFor(user: User): NavSection[] {
    const base: NavSection = {
        items: [
            { label: 'Dashboard', href: '/dashboard', iconPath: icons.home, routeName: 'dashboard' },
        ],
    };
    ...
    if (user.roles.includes('admin')) {
        return [
            base,
            {
                ...
                items: [
                    { label: 'User Management', href: '/admin/users', iconPath: icons.users },
                    { label: 'Roles & Permissions', href: '/admin/roles', iconPath: icons.shield },
                    { label: 'Job Moderation', href: '#', iconPath: icons.briefcase },
                ],
            },
            {
                title: 'System',
                items: [
                    { label: 'System Reports', href: '#', iconPath: icons.chart },
                    { label: 'Settings', href: '#', iconPath: icons.cog },
                ],
            },
        ];
    }
    ...
    if (user.roles.includes('alumni_affairs')) {
        return [
            base,
            {
                ...
                items: [
                    { label: 'Alumni Records', href: '#', iconPath: icons.users },
                    { label: 'Surveys', href: '/surveys', iconPath: icons.clipboard },
                    { label: 'Employability Reports', href: '/reports/employability', iconPath: icons.chart },
                    { label: 'Career Activities', href: '#', iconPath: icons.academicCap },
                ],
            },
        ];
    }
    ...
    if (user.roles.includes('department_head')) {
        return [
            base,
            {
                title: 'Analytics',
                items: [
                    { label: 'Employment Statistics', href: '/reports/employability', iconPath: icons.chart },
                    { label: 'Graduate Profiles', href: '#', iconPath: icons.users },
                ],
            },
        ];
    }
